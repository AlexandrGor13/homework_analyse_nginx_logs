...
def setup_logs(tmp_path):
    ...
    filenames = [
        ...
        "nginx-access-ui.log-20251015.gz",
    ]
...
def test_find_latest_file_correctly_selects_latest(setup_logs: str):
    ...
    assert analyzer.log_file_data.file_name == "nginx-access-ui.log-20251015.gz"
    assert analyzer.log_file_data.file_date == "2025.10.15"
